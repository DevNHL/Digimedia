...
<body class="body">
   ...
   <div class="con-anun3" style="background: #6A27B5;">
        <div class="parrafos1">
   ...
   <div class="con-anun1" style="background: #009BFF;">
    <div class="col-5"></div>
        ...
        <tr>
            <td></td>
            <td><div>
                <iframe style="padding: 60px 300px 0px 0px; float:right" width="860" height="375" allowfullscreen="1" src="https://www.youtube.com/watch?v=7V1WL_7x2io"></iframe>
                <h2 style="padding: 100px 1000px 0px 0px; font-size:60px;text-shadow:rgba(0, 0, 0, 0.4) 0px 4px 5px;" class="titulo1">¿QUE ES <a style="background:#FF0C7D"> SEO</a> PARA PAGINA WEB?</h5>
            </div></td>
        </tr>
        </tbody>
        </table>
    ...
    <div class="parrafos1">
            <h5 class="titulo1" style="font-size:50px; text-shadow:rgba(0, 0, 0, 0.4) 0px 4px 5px;">¿No encontraste lo que<br> buscabas?</h5>
            <div class="pt-3"></div>
