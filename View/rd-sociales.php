...
<head>
    ...
    <link rel="stylesheet" href="../css/gestion_redes.css?5555d">
...
<body>
    ...
    <div class="banerprincipal">
        <div class="padre">
            <div class="contenedors">
                ...
                <p class="sub">En Digimedia ayudaremos a mejorar la imagen de tu marca. Asi mismo, a incrementar y conquistar <br>
    ...
    <div class="bannersec">
        <div class="conrs">
            <div class="cont">
                <div class="titulo">
                    <p class="tes">Servicio de Social Media</p>
                </div>
    ...
    <div class="bannersec3">
        <div class="conrs2">
            <div class="cont2">
                <div class="titulo2">
                    <p class="tes">Conoce nuestro servicio de gesti&oacute;n de redes sociales para tu empresa</p>
                </div>
    ...
    <div class="bannersec4">
        <div class="conrs" id="o">
            <div class="cont" id="co">
                <div class="titulo">
                    <p class="tes">Creaci&oacute;n del Social Profile</p>
                </div>
    ...
    <div class="bannersec5">
        <div class="conrs"  id="s">
            <div class="cont" id="cs">
                <div class="titulo2">
                    <p class="tes">Creaci&oacute;n de Contenido para Redes Sociales</p>
                </div>
    ...
    <div class="bannersec6">
        <div class="conrs" id="con">
            <div class="cont" id="sw">
                <div class="titulo">
                    <p class="tes">Monitoreo de Redes Sociales</p>
                </div>
